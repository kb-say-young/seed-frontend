...
const rec: Rec[] = [
  { label: '주거', pct: 48, actual: 6_000_000, budget: 10_000_000, dot: 'bg-cat-housing', color: 'var(--color-cat-housing)' },
  { label: '생활', pct: 23, actual: 3_500_000, budget: 4_000_000, dot: 'bg-cat-living', color: 'var(--color-cat-living)' },
  { label: '취·창업', pct: 14, actual: 1_800_000, budget: 5_000_000, dot: 'bg-cat-work', color: 'var(--color-cat-work)' },
  { label: '저축', pct: 15, amount: 1_232_000, dot: 'bg-cat-finance', color: 'var(--color-cat-finance)' },
]
        ...
        <div class="mt-3 glass rounded-2xl p-4">
          <div class="glass rounded-xl p-4">
            ...
            <StackedBar
              ...
              :height="12"
              :legend="false"
              :segments="rec.map((r) => ({ label: r.label, value: r.pct, color: r.color }))"
            />
          </div>
