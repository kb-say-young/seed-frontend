...
<template>
  <RouterLink
    :to="props.to"
    class="block rounded-2xl border border-border bg-surface p-4 no-underline"
  >
    ...
    <div
      ...
      class="mt-2.5 h-1.5 w-full overflow-hidden rounded-full bg-surface-subtle"
      aria-hidden="true"
    >
      <div
        class="h-full rounded-full"
        :style="{ width: `${props.progress}%`, background: barColor }"
      />
    </div>
