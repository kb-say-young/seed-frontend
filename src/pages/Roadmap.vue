...
import { BUCKETS, MILESTONES } from '../lib/roadmap'
...
<template>
  <div class="relative bg-surface-subtle">
    <header
    ...
    <main id="main" class="space-y-4 px-5 pb-32 pt-2">
      ...
      <AlertCard title="지원이 끝나는 시점이 위험해요">
      ...
      <section aria-label="타임라인">
        ...
        <p v-if="buckets.length === 0" class="mt-4 rounded-xl bg-surface p-4 text-body-sm text-muted">
