...
<template>
  <div class="flex min-h-svh flex-col bg-surface">
    ...
    <main id="main" class="flex-1 space-y-5 px-5 pt-2">
      <div class="rounded-2xl bg-primary-tint p-4">
      ...
      <div>
        ...
        <span class="inline-flex rounded-full bg-surface-subtle px-3.5 py-2 text-body-sm text-muted">
          자금 · 비상금 (목표에서 자동 지정)
        </span>
      </div>
    ...
    <div
      class="sticky bottom-0 space-y-2.5 bg-surface px-5 pb-7 pt-3"
